...
export const selectProducingState: MemoizedSelector<object, State> =
  createFeatureSelector<State>('producing');

export const selectProducingError: MemoizedSelector<object, string> =
  createSelector(selectProducingState, getError);

export const selectProducingIsLoading: MemoizedSelector<object, boolean> =
  createSelector(selectProducingState, getIsLoading);

export const selectProducingSounds: MemoizedSelector<object, Sound[]> =
