...
export const selectGlobalState: MemoizedSelector<object, State> =
  createFeatureSelector<State>('global');

export const selectGlobalError: MemoizedSelector<object, string> =
  createSelector(selectGlobalState, getError);

export const selectGlobalIsLoading: MemoizedSelector<object, boolean> =
  createSelector(selectGlobalState, getIsLoading);

export const selectGlobalSection: MemoizedSelector<object, string> =
